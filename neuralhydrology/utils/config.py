...
class Config(object):
    ...
    @property
    def bvi(self) -> bool:
        return self._cfg.get("bvi", False)

    @property
    def lstmini(self) -> bool:
        return self._cfg.get("lstmini", False)
    
    @property
    def headini(self) -> bool:
        return self._cfg.get("headini", False)
    
    @property
    def guideini(self) -> bool:
        return self._cfg.get("guideini", False)
    
    @property
    def guideinipath(self) -> str:
        return self._cfg.get("guideinipath", None)
    
    
    @property
    def bvisigma(self) -> float:
        return self._cfg.get("bvisigma", 0.1)

    @property
    def lstmfix(self) -> bool:
        return self._cfg.get("lstmfix", 0)

    @property
    def headfix(self) -> bool:
        return self._cfg.get("headfix", 0)

    @property
    def transferfix(self) -> bool:
        return self._cfg.get("transferfix", 0)
    
    @property
    def lstmdet(self) -> float:
        return self._cfg.get("lstmdet", 0)
    
    @property
    def bviwithini(self) -> bool:
        return self._cfg.get("bviwithini", False)
    
    @property
    def inipath(self) -> str:
        return self._cfg.get("inipath", None)
    
    @property
    def svitest(self) -> bool:
        return self._cfg.get("svitest", 0)
    
    @property
    def svimodel(self) -> str:
        return self._cfg.get("svimodel", None)   
    ...
    @property
    def finetune_params(self) -> str:
        return self._get_value_verbose("finetune_params")
    ...
    @property
    def obserrormodel_beta(self) -> float:
        return self._cfg.get("obserrormodel_beta",0)

    @property
    def obserrormodel_eta(self) -> float:
        return self._cfg.get("obserrormodel_eta",0)
    
    @property
    def obserrormodel_num(self) -> int:
        return self._cfg.get("obserrormodel_num",1)
