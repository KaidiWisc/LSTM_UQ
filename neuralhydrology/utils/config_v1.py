...
class Config(object):
    ...
    def obserrormodel_beta(self) -> float:
        return self._get_value_verbose("obserrormodel_beta")
        # return self._cfg.get("ObsErrorModel_Beta", None)
    @property
    def obserrormodel_eta(self) -> float:
        return self._get_value_verbose("obserrormodel_eta")
        # return self._cfg.get("ObsErrorModel_Eta", None)
    @property
    def obserrormodel_num(self) -> int:
        return self._get_value_verbose("obserrormodel_num")
        # return self._cfg.get("ObsErrorModel_Num", None)
